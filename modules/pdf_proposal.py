...
def _make_header_footer(title: str, date_str: str):
    def _draw(canvas, doc):
        ...
        canvas.drawString(0.5 * inch, page_h - 0.35 * inch, "Green Chemistry Formulation Proposal")
        ...
        canvas.drawCentredString(
            page_w / 2, 0.35 * inch,
            f"ChemeNova LLC x ChemRich Global  |  shehan@chemenova.com  |  Page {doc.page}"
        )
...
def generate_proposal_pdf(
    ...
    # Navy cover band
    cover_band = Table(
        [[Paragraph("Green Chemistry Formulation Proposal", s["cover_title"]),
    ...
    story.append(Paragraph(
        "<i>This proposal was generated by the IntelliForm AI Platform (ChemeNova LLC, v0.9). "
